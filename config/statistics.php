...
return [
    ...
    'name_route' => ['main', 'boutique'], //названия маршрутов по которым будет собираться статистика. Например ['posts','contact']

    'days_default' => 99999, //кол-во дней для вывода статистики по-умолчанию (сегодня/вчера)
