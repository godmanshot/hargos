                            ...
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" align="center" style="background-color: transparent;" bgcolor="transparent">
                                        <div>
                                            <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0" cellspacing="0" width="800" style="background-color: rgb(255, 255, 255);">
                                                <tbody>
                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-image"><a target="_blank"><img class="adapt-img" src="{{asset('images/logo-email.png')}}" alt style="display: block;" width="155"></a></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
                            ...
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" align="center" bgcolor="transparent" style="background-color: transparent;">
                                        <table bgcolor="transparent" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="800" style="background-color: transparent;">
                                            <tbody>
                                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" align="center">
                                        <table bgcolor="#31cb4b" class="es-footer-body" align="center" cellpadding="0" cellspacing="0" width="800">
                                            <tbody>
                                                <tr>
