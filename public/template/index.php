					...
					<ul class="glide__slides">
						<li class="glide__slide">
							<div class="container">
								<div class="row">
									<div class="col-xl-5">
										<h1>Международный меховой город «Кинг Конг»</h1>
									</div>
									<div class="col-xl-7">
								...
								<div class="row">
									<div class="col-xl-6">
										<p>
										Меховой центр "King Kong" предлагает шубы, полушубки, пальто, шапки,
										дубленки, шарфы, куртки, женская одежда, зимние головные уборы из натурального
										меха, автошины, автоинструмент, телефоны и прочее...
										</p>
									</div>
