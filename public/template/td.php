        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-xl-12 mb-3">
                    <h1 class="category__header">Выберите категорию</h1>
                </div>
                <div class="col-xl-12">
                    <div class="row">
                        <div class="col-lg-2 col-md-3 col-sm-6">
                           <button class="category-btn">Продукты</button>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-6">
                           <button class="category-btn">Продукты</button>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-sm-9">
                                <ul class="filter__wrapper">
                                    <li><button class="filter-btn">По популярности</button></li>
                                    <li><button class="filter-btn top-products">TOP товары</button></li>
                                    <li><button class="filter-btn discounts">Скидки %</button></li>
                                    <li><button class="filter-btn novelties">NEW</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-7 col-sm-12 col-12 about-boutique__info-wrapper">
                        <div class="row align-items-end">
                            <div class="col-xl-2 col-lg-4 col-md-3 col-sm-4 col-4">
                                <h1 class="boutique-header">Oodji</h1>
                            </div>
