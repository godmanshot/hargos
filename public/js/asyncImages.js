...
/***/ "./node_modules/network-information-api-polyfill/dist/main.js":
/*!********************************************************************!*\
  !*** ./node_modules/network-information-api-polyfill/dist/main.js ***!
  \********************************************************************/
/*! no static exports found */
...
eval("var networkInformationApiPolyfill = __webpack_require__(/*! network-information-api-polyfill */ \"./node_modules/network-information-api-polyfill/dist/main.js\");\n\nvar type;\nvar asyncImages = document.getElementsByClassName('asyncImage');\nnew NetworkInformationApiPolyfill().then(function (connection) {\n  type = connection.effectiveType;\n  connection.addEventListener('change', updateConnectionStatus);\n  var _iteratorNormalCompletion = true;\n  var _didIteratorError = false;\n  var _iteratorError = undefined;\n\n  try {\n    for (var _iterator = asyncImages[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n      var asyncImage = _step.value;\n      loadImage(asyncImage, type);\n    }\n  } catch (err) {\n    _didIteratorError = true;\n    _iteratorError = err;\n  } finally {\n    try {\n      if (!_iteratorNormalCompletion && _iterator[\"return\"] != null) {\n        _iterator[\"return\"]();\n      }\n    } finally {\n      if (_didIteratorError) {\n        throw _iteratorError;\n      }\n    }\n  }\n});\n\nfunction updateConnectionStatus(e) {\n  if (parseInt(e.target.effectiveType) > parseInt(type)) {\n    var _iteratorNormalCompletion2 = true;\n    var _didIteratorError2 = false;\n    var _iteratorError2 = undefined;\n\n    try {\n      for (var _iterator2 = asyncImages[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {\n        var asyncImage = _step2.value;\n        loadImage(asyncImage, e.target.effectiveType);\n      }\n    } catch (err) {\n      _didIteratorError2 = true;\n      _iteratorError2 = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion2 && _iterator2[\"return\"] != null) {\n          _iterator2[\"return\"]();\n        }\n      } finally {\n        if (_didIteratorError2) {\n          throw _iteratorError2;\n        }\n      }\n    }\n  }\n\n  type = e.target.effectiveType;\n}\n\nfunction loadImage(image, connection) {\n  var dataSrc = image.getAttribute('data-src').split('/');\n  dataSrc[dataSrc.length - 1] = connection + '_' + dataSrc[dataSrc.length - 1];\n  dataSrc = dataSrc.join('/');\n\n  if (image.classList.contains('async-lazy')) {\n    if (image.classList.contains('async-figure')) {\n      image.parentNode.style.backgroundImage = 'url(' + dataSrc + ')';\n    } else {\n      image.setAttribute('data-lazy', dataSrc);\n      console.log(image);\n    }\n  } else {\n    if (image.classList.contains('async-figure')) {\n      image.parentNode.style.backgroundImage = 'url(' + dataSrc + ')';\n    } else {\n      image.src = dataSrc;\n    }\n  }\n}\n\n//# sourceURL=webpack:///./resources/js/asyncImages.js?");

/***/ }),

/***/ 1:
/*!**********************************************************!*\
  !*** multi babel-polyfill ./resources/js/asyncImages.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./resources/js/asyncImages.js */\"./resources/js/asyncImages.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./resources/js/asyncImages.js?");
